  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.inputContainer}>
        <TextInput placeholder="Nombre" placeholderTextColor="#99988B" style={inputStyles.input} />
        <TextInput placeholder="Apellido" placeholderTextColor="#99988B" style={inputStyles.input} />
        <TextInput placeholder="Domicilio Legal" placeholderTextColor="#99988B" style={inputStyles.input} />
        <TextInput placeholder="País de Origen" placeholderTextColor="#99988B" style={inputStyles.input} />
      </View>
