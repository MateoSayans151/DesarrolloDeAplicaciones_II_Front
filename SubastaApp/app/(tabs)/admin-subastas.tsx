    ...
    <View style={s.card}>
      ...
      {confirmDelete ? (
        ...
        <View style={s.actionRow}>
          <TouchableOpacity style={s.catBtn} onPress={() => router.push(`/(tabs)/admin-catalogos?subastaId=${item.id}` as any)} activeOpacity={0.8}>
  ...
  return (
    <ScreenLayout activeTab="admin-subastas">
      <View style={s.header}>
        ...
        <TouchableOpacity style={s.addBtn} onPress={() => router.push("/(tabs)/crear-subasta" as any)} activeOpacity={0.8}>
