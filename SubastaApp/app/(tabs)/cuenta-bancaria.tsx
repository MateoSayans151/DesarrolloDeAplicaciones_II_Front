...
export default function CuentaBancariaScreen() {
  return (
    <View style={styles.container}>
      ...
      <TextInput placeholder="Titular de Cuenta" style={styles.input} />
      <TextInput placeholder="Tipo de Cuenta" style={styles.input} />
      <TextInput placeholder="Moneda" style={styles.input} />
      <TextInput placeholder="CBU / Alias" style={styles.input} />
